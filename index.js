let { WAConnection: _WAConnection, WA_MESSAGE_STUB_TYPES } = require('@villopratama/vap')
...
global.mods = ['6283843251769@s.whatsapp.net']
global.prems = ['6283843251769@s.whatsapp.net']
